    ...
    <div class="container">
        ...
        <div class="col-lg-8 pl-lg-0">
                    ...
                    @forelse ($item->details as $detail)
                        <tr>
                            ...
                            <td class="align-middle">
                                ...
                                <img src="{{ url('frontend/images/icn-remove – 1.png') }}" alt="">
                                </a>
                            </td>
                        </tr>
                    @empty
            ...
            <div class="member mt-3">
                ...
                You are only able to invite member that has registered in Travelizm 
                </p>
            </div>
            </div>
        </div>
            ...
            <div class="card card-details card-right">
                ...
                <tr>
                    ...
                    <span class="text-darkgreen">$ {{ $item->transaction_total }},</span>
                    <span class="text-lightgreen">{{ mt_rand(0,99) }}</span>
                    </td>
                </tr>
                </table>
                <hr />
            ...
            <div class="join-container">
                <a href="{{ route('checkout-success', $item->id) }}" class="btn btn-block 
